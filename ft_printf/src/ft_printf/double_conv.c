...
/*   Updated: 2018/12/31 13:49:22 by mguerrea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char			*get_decimal(double f, long long n, int prec)
{
	long long	d;
	int			len;
	int			i;
...
static char			*get_formatted_string(double f, t_options options)
{
	char	*s;
	int		len;
	int		sign;
...
static char			*join_parts(double f, t_options options,
